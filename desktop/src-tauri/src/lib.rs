...
struct ConversionRequest {
    ...
    main_quality: Option<u32>,
    preview_quality: Option<u32>,
    pyramid_quality: Option<u32>,
    parallel_wsi: Option<u32>,
    output_to_new_subfolder: Option<bool>,
...
async fn start_conversion(
    ...
    let start_payload = json!({
        ...
        "payload": {
            ...
            "main_quality": request.main_quality.unwrap_or(90),
            "preview_quality": request.preview_quality.unwrap_or(70),
            "pyramid_quality": request.pyramid_quality.unwrap_or(60),
            "parallel_wsi": request.parallel_wsi.unwrap_or(1),
            "output_to_new_subfolder": request.output_to_new_subfolder.unwrap_or(false),
